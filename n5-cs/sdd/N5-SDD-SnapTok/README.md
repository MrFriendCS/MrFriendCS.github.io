...
A program is required to create a user account.
The user will enter their age and location.
The program will determine if they are eligible for an account and display an appropriate message.
If the user is eligible they will enter a username and password.
They will re-enter the username and password.
The program will determine if the information matches and display an appropraite message.
