...
-- Task 11 - Guidance teacher: Slytherin / Gryffindor
...
-- Task 13 - Same surname and at least 14
SELECT *
    FROM Pupil
...
-- Task 14 - Pupil records sorted by surname and forename
SELECT *
    FROM Pupil
...
-- Task 15 - Name and id, sorted by age and surname
...
-- Task 16 - S5 / S6 names and year, sorted
SELECT firstName, lastName, year
    FROM Pupil
    WHERE year = "S5"
       OR year = "S6"
...
-- Task 17 - Houses sorted by colour
SELECT colour, emblem, name
    FROM House
    ORDER BY colour ASC;


-- Task 18 - Display full name and house of S5 pupils
...
-- Task 19 - Full name and house younger than 13
SELECT firstName, lastName, name
    FROM House, Pupil
    WHERE House.id = Pupil.houseID
      AND age < 13;
...
-- Task 20 - Forename and house of pupils who are 14
