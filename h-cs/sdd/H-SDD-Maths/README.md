...
Create a file called `mathsFuncs.py`.
...
Save the file [`mathsFuncsTests.py`](assets/mathsFuncsTests.py) to the same folder as `mathsFuncs.py`.
Open and run `mathsFuncsTests.py`.
