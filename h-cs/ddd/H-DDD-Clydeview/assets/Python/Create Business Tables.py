...
fileIn = open("../CSV/CustomerOrder.csv", "r")
fileOut = open("../SQL/CustomerOrder.sql", "w")
...
fileIn = open("../CSV/Supplier.csv", "r")
fileOut = open("../SQL/Supplier.sql", "w")
...
fileIn = open("../CSV/Product.csv", "r")
fileOut = open("../SQL/Product.sql", "w")
...
fileIn = open("../CSV/OrderProduct.csv", "r")
fileOut = open("../SQL/OrderProduct.sql", "w")
